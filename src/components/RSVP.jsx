...
// Sección para invitar a confirmar asistencia
const RSVP = () => {
  return (
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-xl text-white/80 mb-4">
            ¿Nos acompañás en nuestra celebración?
          </p>
        ...
        >
          <div className="space-y-6">
            ...
            <Link to="/confirmar" className="block">
              <motion.button
                className="w-full bg-gradient-to-r from-[#2c3e50] to-[#bfa977] text-white px-8 py-4 rounded-full text-lg font-semibold btn-glow flex items-center justify-center space-x-2"
