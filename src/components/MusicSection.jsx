...
// Sección para sugerir canciones con estilos elegantes
const MusicSection = () => {
  const categories = ['Románticas', 'Clásicos', 'Bachata'];
  return (
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            ¡Ayudanos sugiriendo las canciones que no pueden faltar en nuestra boda!
          </p>
        </motion.div>
        <motion.div
        ...
        <Link to="/musica">
          <motion.button
            className="bg-gradient-to-r from-[#2c3e50] to-[#bfa977] text-white px-8 py-4 rounded-full text-lg font-semibold btn-glow flex items-center space-x-2 mx-auto"
