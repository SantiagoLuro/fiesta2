...
/**
 * Sección de cuenta regresiva hasta la fecha de la boda.
 * Muestra días, horas, minutos y segundos restantes utilizando
 * animaciones suaves de Framer Motion y estilizado consistente con
 * la paleta minimalista neutra/dorada.
 */
const CountdownSection = () => {
  ...
  useEffect(() => {
    // Fecha y hora del evento (22 Noviembre 2025 a las 19:30)
    const eventDate = new Date('2025-11-22T19:30:00').getTime();
